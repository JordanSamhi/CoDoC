...
TRAIN_DIR=android_source/android_source_train
VAL_DIR=android_source/android_source_val
TEST_DIR=android_source/android_source_test
DATASET_NAME=android_source
MAX_CONTEXTS=200
